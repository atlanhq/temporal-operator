...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SchemaPreflightSpec) DeepCopyInto(out *SchemaPreflightSpec) {
	*out = *in
	if in.Enabled != nil {
	...
	if in.MinTableBytes != nil {
		in, out := &in.MinTableBytes, &out.MinTableBytes
		*out = new(int64)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SchemaPreflightSpec.
func (in *SchemaPreflightSpec) DeepCopy() *SchemaPreflightSpec {
	if in == nil {
		return nil
	}
	out := new(SchemaPreflightSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TemporalClusterSpec) DeepCopyInto(out *TemporalClusterSpec) {
	*out = *in
	...
	if in.VersionUpgrade != nil {
		in, out := &in.VersionUpgrade, &out.VersionUpgrade
		*out = new(VersionUpgradeSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionUpgradeSpec) DeepCopyInto(out *VersionUpgradeSpec) {
	*out = *in
	if in.StabilityDuration != nil {
		in, out := &in.StabilityDuration, &out.StabilityDuration
		*out = new(metav1.Duration)
		**out = **in
	}
	if in.IntermediateVersions != nil {
		in, out := &in.IntermediateVersions, &out.IntermediateVersions
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionUpgradeSpec.
func (in *VersionUpgradeSpec) DeepCopy() *VersionUpgradeSpec {
	if in == nil {
		return nil
	}
	out := new(VersionUpgradeSpec)
